...
def load_args():
    ...
    parser.add_argument('--pre_train_path', type=str, default="./results/2025-03-02/model_best.pth")  # model_best model_last_epochs_4
    ...
    parser.add_argument('--wm_length', type=int, default=16)
    # parser.add_argument('--mode', type=str, default="train")
    parser.add_argument('--mode', type=str, default="test")
    # parser.add_argument('--wm_mode', type=str, default="wm")
    parser.add_argument('--wm_mode', type=str, default="nowm")
    ...
    # test arguments
    parser.add_argument("--test_image_path", type=str, default="./results/2025-03-02/perturbed_images")
